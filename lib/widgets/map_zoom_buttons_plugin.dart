...
class MapZoomButtonsPluginOption extends LayerOptions {
  final int minZoom;
  final int maxZoom;
  final bool mini;
...
class MapZoomButtonsPlugin implements MapPlugin {
  ...
  Widget createLayer(
    ...
    if (options is MapZoomButtonsPluginOption) {
  ...
  bool supportsLayer(LayerOptions options) {
    return options is MapZoomButtonsPluginOption;
  }
}

class ZoomButtons extends StatelessWidget {
  final MapZoomButtonsPluginOption zoomButtonsOpts;
  final MapState map;
        ...
        children: <Widget>[
          Padding(
            ...
            child: FloatingActionButton(
              ...
              backgroundColor:
                  zoomButtonsOpts.zoomInColor ?? Theme.of(context).buttonColor,
              onPressed: () {
          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              mini: zoomButtonsOpts.mini,
              backgroundColor:
                  zoomButtonsOpts.zoomOutColor ?? Theme.of(context).buttonColor,
              onPressed: () {
                var bounds = map.getBounds();
                var centerZoom = map.getBoundsCenterZoom(bounds, options);
                var zoom = centerZoom.zoom - 1;
